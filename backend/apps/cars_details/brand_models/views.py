...
from backend.apps.cars_details.brand_models.models import CarBrandModel, CarsModelModel
from backend.apps.cars_details.brand_models.serializers import CarBrandSerializer, CarsModelSerializer
