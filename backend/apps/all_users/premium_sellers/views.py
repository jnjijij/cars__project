...
from backend.apps.all_users.premium_sellers.serializers import PremiumSellerSerializer
from backend.apps.all_users import UserModel as User
from backend.apps.all_users import UserSerializer
from backend.apps.cars_details import CarModelV2
from backend.apps.cars_details import PremiumSellersCarsSerializer
